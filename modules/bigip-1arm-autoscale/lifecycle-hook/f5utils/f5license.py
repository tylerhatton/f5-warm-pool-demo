...
def revoke_bigip_license(bigiq_server, bigiq_username, bigiq_password, bigiq_license_pool_name, bigip_instance_id):
    ...
    try:
        ...
        while retries < max_retries:
            ...
            if 'licenseText' in license_file_response.json():
                ...
                message = 'BIG-IQ returned a status FAILED on licensing: {}'.format(
                    error)
                logger.error(message)
                raise Exception(message)
